...
You can use [Dasharo Tools Suite (DTS)](https://docs.dasharo.com/dasharo-tools-suite/releases/)
...
section in the [Initial deployment documentation](https://docs.dasharo.com/variants/msi_z690/initial-deployment/#initial-deployment-manually).
...
menu and invoke following commands (they will also work in any Linux terminal
with wget installed):
...
Issues described above (and also a few issue resolved before, e.g.
...
![](/img/rgb_perfectly_balanced.png)
...
alltogether creates a white light, a sunlight; and sunlight means life...
