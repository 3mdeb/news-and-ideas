...
[Dasharo Security Options](https://docs.dasharo.com/dasharo-menu-docs/dasharo-system-features/).
...
You can use flashrom from DTS Shell or your own Linux distribution with up to
date flashrom for firmware update purpose. Procedure for getting the right
