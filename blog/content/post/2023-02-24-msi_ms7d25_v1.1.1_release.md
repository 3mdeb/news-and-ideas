...
You can use flashrom from DTS Shell for that purpose. To download a binary to
the booted DTS simply invoke:
...
memory controller registers and let Dasharo boot). The process is not needed if
you update from Dasharo.
