...
Each stand will be opened by presentation. After that we will open 3mdeb and Qubes OS and chat discussion about the topic, from which we will pick questions. After two presentations (2 hours approximately), we will start 30min AMA related to given day theme.

 into broad status report, design talk with proposals
