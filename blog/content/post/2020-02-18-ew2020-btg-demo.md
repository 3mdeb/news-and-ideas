...
hash of the key used to sign Key Manifest can be burned into the ME and locked
...
network focused product called the Vault by implementing Boot Guard. Protectli
sells compact network devices running Intel processors and the most powerful of
them have Intel processors which are Boot Guard capable. As a matter of fact,
3mdeb had previously implemented coreboot for these platforms, so implementing
Boot Guard was a natural enhancement to the overall security of the system. 
