...
our Dasharo Enterprise offering.
...
This transition brings a notable enhancement to the firmware's cryptographic
system, introducing support for the SHA-3 hash algorithm, known for
its higher security levels than its predecessors. Dasharo source code is
...
also closer to the most recent UEFI specification version, 2.10 (released
in August 2022).
