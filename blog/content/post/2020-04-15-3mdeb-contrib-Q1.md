...
applications helping our clients reach their goals. During the everyday work
sometimes we struggle with frustrating problems that shouldn't occur at the
first place. When we finally deal with the issues, first thing we want to do is
to share the good news with the related community. This is our main motivation
behind our hard work - to share the knowledge by taking part in the open source
community and help developers and enthusiasts with samples of codes. The
positive feedback from the users is the priceless reward that drives us to
...
patches that has not been merged yet) getting in total over **16k**
...
3. [acpica](https://github.com/acpica/acpica)
    ...
    > operating system-independent implementation of the Advanced Configuration and
...
TBD: We are not going to rest on our laurels ...

## Last but not least news

TBD: About opensource.3mdeb.com ...
...
do things in example project and build the reputation around people who are
