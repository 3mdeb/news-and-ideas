...
- [GRUB #21](https://github.com/TrenchBoot/grub/pull/21)
- [GRUB #28](https://github.com/TrenchBoot/grub/pull/28)
- [GRUB #29](https://github.com/TrenchBoot/grub/pull/29)
- [GRUB #30](https://github.com/TrenchBoot/grub/pull/30)
- [Xen #21](https://github.com/TrenchBoot/xen/pull/21)
- [Xen #23](https://github.com/TrenchBoot/xen/pull/23)
- [Xen #24](https://github.com/TrenchBoot/xen/pull/24)
- [Xen #25](https://github.com/TrenchBoot/xen/pull/25)
- [Secure Kernel Loader #21](https://github.com/TrenchBoot/secure-kernel-loader/pull/21)
- [Secure Kernel Loader #23](https://github.com/TrenchBoot/secure-kernel-loader/pull/23)
- [Qubes Anti Evil Maid #13](https://github.com/TrenchBoot/qubes-antievilmaid/pull/13)
...
5. Prepare list of AEM packages:
    ...
    packages=(
        ...
        "python3-xen-4.17.5-6.fc37.x86_64"
        "xen-4.17.5-6.fc37.x86_64"
        "xen-hypervisor-4.17.5-6.fc37.x86_64"
        "xen-libs-4.17.5-6.fc37.x86_64"
        "xen-licenses-4.17.5-6.fc37.x86_64"
        "xen-runtime-4.17.5-6.fc37.x86_64"
    )
    ```
    ...
    ```shell
    packages+=(
        "secure-kernel-loader-0+3c6653085f7b183397a77f94284079b7b08e2c60-1.fc37.x86_64"
    )
    ```
