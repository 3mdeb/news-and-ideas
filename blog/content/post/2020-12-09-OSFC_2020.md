...
John presented typical stages of hardware production (Prototype -> EVT ->
DVT -> PVT -> Mass production), and testing in light of problems with firmware ecosystem. 1000 reboots test are Facebook
