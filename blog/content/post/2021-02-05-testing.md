...
To simplify our work, we are using [Remote testing environment](https://jira-3mdeb.atlassian.net/browse/SHA-195?focusedCommentId=55760&page=com.atlassian.jira.plugin.system.issuetabpanels%3Acomment-tabpanel#comment-55760)
which runs specially crafted Linux distribution using the Yocto Project. We
developed rte to enable programmers a low level firmware development without
hassle of heavy KVM switch interface.
![RTA](/img/RTA.png)
