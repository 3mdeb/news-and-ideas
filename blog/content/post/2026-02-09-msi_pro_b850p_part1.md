...
are not much different from MSI PRO Z690-A/Z790-P. However, it must be noted
...
2. `PCIE1`:
   ...
   * Up to 6 bridges
   * 8 lanes total
   * PCI addresses of the bridges 00:02.1 - 00:02.6
...
3. Rest of the slots on the mainboard map to Promontory chipset B850.
   ...
   * 8 lanes PCIe Gen 4
   * 4 or 8 lanes PCIe Gen3 (depends on chipset model)
